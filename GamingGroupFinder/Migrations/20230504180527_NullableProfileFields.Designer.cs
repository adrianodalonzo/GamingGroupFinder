...
namespace _410project.Migrations
{
    ...
    [Migration("20230504180527_NullableProfileFields")]
    partial class NullableProfileFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GamingGroupFinderGUI.Models.EventDB", b =>
                {
                    ...
                    b.HasOne("GamingGroupFinderGUI.Models.RankDB", "MaxRank")
                        .WithMany()
                        .HasForeignKey("MaxRankId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GamingGroupFinderGUI.Models.RankDB", "MinRank")
                        .WithMany()
