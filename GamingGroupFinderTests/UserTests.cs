...
namespace GamingGroupFinderTests {
    ...
    public class UserTests {
        ...
        public void TestConstructor_ThrowsWhenGivenNull() {
            User user = new User(null, "password", "salt", new List<User>());
        ...
        public void TestEquals_ReturnsCorrect() {
            User vince = new User("vince", "vince", "salt", new List<User>());
            User maybeVince = new User("vince", "vince", "salt", new List<User>());
        ...
        public void TestEquals_ReturnsIncorrect() {
            User vince = new User("vince", "vince", "salt", new List<User>());
            User maybeVince = new User("notvince", "notVince", "salt", new List<User>());
